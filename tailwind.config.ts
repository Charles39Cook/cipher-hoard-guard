  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Guild Vault Theme Colors
        "vault-stone": "hsl(var(--vault-stone))",
        "vault-iron": "hsl(var(--vault-iron))",
        "vault-gold": "hsl(var(--vault-gold))",
        "hologram-blue": "hsl(var(--hologram-blue))",
        "hologram-purple": "hsl(var(--hologram-purple))",
      ...
      boxShadow: {
        ...
        "hologram-glow": "var(--glow-hologram)",
        "gold-glow": "var(--glow-gold)",
        "encryption-glow": "var(--glow-encryption)",
      },
      fontFamily: {
        "medieval": ["Cinzel", "Georgia", "serif"],
        "tech": ["Orbitron", "Courier New", "monospace"],
      },
      borderRadius: {
        lg: "var(--radius)",
